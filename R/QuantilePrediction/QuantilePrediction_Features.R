...
TTRWrapper <- function(SD, f, SDcols, Normalize, SDcolsOut = NULL, SDcolsPlus = NULL, Transform = NULL, Suffix = NULL, Aggreagation = "mean", ...){
# TTRWrapper <- function(SD, f, SDcols, Normalize, SDcolsOut = NULL, SDcolsPlus = NULL, Transform = NULL, Suffix = NULL, ...){
  ...
  SDcolsOut <- str_c(colnames(temp), Suffix)
  colnames(temp) <- SDcolsOut
...
TTR <- list(
  ...
  function(SD, BY) {TTRWrapper(SD = SD, f = SMI, SDcols = c("High", "Low", "Close"), Normalize = F, Suffix = "_n=10", n=30)},
  function(SD, BY) {TTRWrapper(SD = SD, f = SMI, SDcols = c("High", "Low", "Close"), Normalize = F, Suffix = "_n=10", n=60)},
